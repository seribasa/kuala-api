...
import { handleGetInvoiceById } from "../../../kuala/handlers/invoices/get-by-id.ts";
...
Deno.test("handleGetInvoiceById - should return 404 when Kill Bill throws INVOICE_NOT_FOUND", async () => {
	const mockUser = {
		id: "user123",
		email: "test@example.com",
	};
...
Deno.test("handleGetInvoiceById - should return invoice successfully", async () => {
	const mockUser = {
		id: "user123",
		email: "test@example.com",
	};
